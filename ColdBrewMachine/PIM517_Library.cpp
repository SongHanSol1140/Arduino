...
IOExpander::Pin::Pin(uint8_t port, uint8_t pin)
  : _type(TYPE_IO), _mode(0), _port(port), _pin(pin), _adcChannel(0), _pwmChannel(0), _reg_m1(PxM1[port]), _reg_m2(PxM2[port]), _reg_p(Px[port]), _reg_ps(PxS[port]), _reg_int_mask_p(MASK_P[port]), _regIoPwm(0), _reg_pwml(0), _reg_pwmh(0) {
}

////////////////////////////////////////////////////////////////////////////////////////////////////
IOExpander::Pin::Pin(uint8_t port, uint8_t pin, uint8_t pwmChannel, uint8_t regIoPwm)
  : _type(TYPE_PWM), _mode(0), _port(port), _pin(pin), _adcChannel(0), _pwmChannel(pwmChannel), _reg_m1(PxM1[port]), _reg_m2(PxM2[port]), _reg_p(Px[port]), _reg_ps(PxS[port]), _reg_int_mask_p(MASK_P[port]), _regIoPwm(regIoPwm), _reg_pwml(PWML[pwmChannel]), _reg_pwmh(PWMH[pwmChannel]) {
}

////////////////////////////////////////////////////////////////////////////////////////////////////
IOExpander::Pin::Pin(uint8_t port, uint8_t pin, uint8_t adcChannel)
  : _type(TYPE_ADC), _mode(0), _port(port), _pin(pin), _adcChannel(adcChannel), _pwmChannel(0), _reg_m1(PxM1[port]), _reg_m2(PxM2[port]), _reg_p(Px[port]), _reg_ps(PxS[port]), _reg_int_mask_p(MASK_P[port]), _regIoPwm(0), _reg_pwml(0), _reg_pwmh(0) {
}

////////////////////////////////////////////////////////////////////////////////////////////////////
IOExpander::Pin::Pin(uint8_t port, uint8_t pin, uint8_t adcChannel, uint8_t pwmChannel, uint8_t regIoPwm)
  : _type(TYPE_ADC_OR_PWM), _mode(0), _port(port), _pin(pin), _adcChannel(adcChannel), _pwmChannel(pwmChannel), _reg_m1(PxM1[port]), _reg_m2(PxM2[port]), _reg_p(Px[port]), _reg_ps(PxS[port]), _reg_int_mask_p(MASK_P[port]), _regIoPwm(regIoPwm), _reg_pwml(PWML[pwmChannel]), _reg_pwmh(PWMH[pwmChannel]) {
}
...
IOExpander::IOExpander(TwoWire& wire, uint8_t address, uint32_t timeout,
  ...
  : _i2cAddr(address), _wire(wire), _debug(debug), _vref(3.3f), _timeout(timeout), _interruptPin(interruptPin), _encoderOffset{ 0, 0, 0, 0 }, _encoderLast{ 0, 0, 0, 0 }, _pins{ Pin::Pwm(1, 5, 5, REG_PIOCON1),
...
float IOExpander::pim517_analogRead(uint8_t pin, uint32_t adcTimeout) {
  // Read the IO pin state.
